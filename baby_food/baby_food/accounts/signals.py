...
def send_email_on_successful_sign_up(instance, created, **kwargs):
    ...
    email_content = render_to_string('email_templates/register-successful.html', {
        'user': instance,
    })  # render_to_string(template, context(like 'user': instance))

    send_mail(
        subject='Welcome to Baby Food!',
