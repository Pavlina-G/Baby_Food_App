...
from baby_food.menus.views import menu_home, menu_no_allergens, menu_with_allergens_last, menu_with_allergens_first
...
urlpatterns = (
    ...
    path('no-allergens/', menu_no_allergens, name='menus no allergens'),
)